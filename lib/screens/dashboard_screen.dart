import 'package:admin/models/dashboard_btn_model.dart';
import 'package:admin/widgets/dashboard_btns.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: SvgPicture.asset('lib/icons/delivery-logistics-shipping-svgrepo-com.svg'),
          ),
          actions: [
            IconButton(
              onPressed: () {
