...
import 'package:admin/consts/app_constants.dart';
import 'package:admin/models/product_model.dart';
import 'package:admin/services/my_app_functions.dart';
...
class _EditOrUploadProductScreenState extends State<EditOrUploadProductScreen> {
  ...
  Future<void> _uploadProduct() async {
    ...
    var ref=await FirebaseStorage.instance.
                  ref('productImages/${_titleController.text.trim()}');
    ...
    var refrance=await FirebaseFirestore.instance.
   collection('products').doc(productId).set(
{
  ...
  MyAppFunctions.showErrorOrWarningDialog(
        context: context,
        subtitle: "Product is uploded successfully",
        fct: () {},
